...
if "snakemake" in sys.modules:
    hits_table_file = snakemake.input["hits_table_file"]
    ...
    hits_table_file = "../data/derived/results/result_hits-mrr.csv"
    netstat_table_file = "../data/stats/network-stats.csv"
    output_file = "../figs/hits.pdf"
...
data_table = data_table.query(f"metric == '{metric}'")
